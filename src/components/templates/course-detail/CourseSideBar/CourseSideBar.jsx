      ...
      <div className="bg-background w-full p-8 rounded-2xl shadow-2xl">
        ...
        <div className="w-11/12 m-auto">
          <div className="flex justify-between items-center border-b p-2.5 border-solid border-neutral-100">
            ...
            <p className="font-bold text-[16px] text-textC">22</p>
          </div>
          ...
          <div className="flex justify-between items-center border-b p-2.5 border-solid border-neutral-100">
            ...
            <p className="font-normal text-[16px] text-textC">پایان یافته</p>
          </div>
          <div className="flex justify-between items-center border-b p-2.5 border-solid border-neutral-100">
            <div className="flex justify-center items-center gap-2">
          ...
          <div className="flex justify-between items-center pt-5">
            ...
            <div className="flex items-center gap-2 justify-center">
                <p className="font-bold text-xl md:text-2xl text-primary-300">500000</p>
