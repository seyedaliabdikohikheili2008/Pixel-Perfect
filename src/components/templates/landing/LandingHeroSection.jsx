    ...
    <>
      <div className="w-full my-24 flex gap-5 flex-col">
        <div className="text-textC xl:w-1/2 lg:w-2/3 md:w-11/12 w-2/3 mx-auto flex flex-col items-center gap-5">
          <h1 className="md:text-5xl text-2xl text-nowrap font-normal">
            آموزش{" "}
            <span className="bg-primary-300 text-white p-2 rounded-[40px]">
              برنامه‌نویسی
            </span>{" "}
            آنلاین آسان
          </h1>
          <h3 className="text-textC md:text-5xl text-2xl">
            سریع و همیشه همراه شما
          </h3>
          <h5 className="text-neutral-800 md:text-lg text-base">
          ...
          <Button children={"اموزش رو شروع کنیم"} buttonClassName="w-62" />
        </div>
