  ...
  return (
    <>
      <div
        ...
        className={`${view2 ? "w-full flex-row items-center p-4 gap-5 shadow-2xl h-75 bg-background rounded-4xl" : "w-70 flex-col"}  flex `}
      >
        <img
          className={`${view2 ? "w-2/5 h-5/6 rounded-[100px]" : "w-full h-60 rounded-t-[20px]"}  overflow-hidden object-cover object-center`}
          src={Img}
          alt=""
        />
        <div
          className={`${view2 ? "w-3/5 h-full" : "w-full h-55.5  bg-background shadow-2xl -translate-y-10"} flex flex-col justify-between px-3 py-6 rounded-2xl`}
        >
          <h2
            className={`${view2 ? "text-xl" : "text-base"} text-textC font-bold text-right`}
          >
            دوره آموزش جامع HTML5
          </h2>
          <p
            className={`${view2 ? "line-clamp-4" : "line-clamp-2"} text-sm font-normal text-textC text-right`}
          >
