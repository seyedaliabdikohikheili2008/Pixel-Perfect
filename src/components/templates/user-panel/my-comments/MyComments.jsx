  ...
  const searchComment =
    commentFlag == "course"
      ? MyCourseComments?.data
        ? Search(MyCourseComments.data.myCommentsDtos, search, "title")
        : []
      : MyNewsComments?.data
        ? Search(MyNewsComments.data.myNewsCommetDtos, search, "title")
        : [];
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-40 relative group">
                          <div className="whitespace-nowrap w-40 text-textC line-clamp-1">
                            {item?.describe}
                          </div>
